 ...
 */
bot.hears('list my tickets','direct_message,direct_mention,mention', function(bot, message) {
  bot.startPrivateConversation(message, function(err, convo) {
    pivotal.project(1479718).stories.all(function(err, stories) {
      var ownedStories = R.filter( function(story) {
        return (story.requestedById == 1850810 || R.contains(1850810, story.ownerIds))
      }, stories)
